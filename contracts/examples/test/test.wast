(module
 ...
 (import "env" "get_trx_origin" (func $get_trx_origin (result i64)))
 ...
 (table 9 9 anyfunc)
 (elem (i32.const 0) $__wasm_nullptr $_ZN4test3byeEy $_ZN8graphene8contract7depositEyNS_5assetE $_ZN8graphene8contract8withdrawEyyNS_5assetE $_ZN4test2hiEy $__stdio_close $__stdout_write $__stdio_seek $__stdio_write)
 (memory $0 1)
 ...
 (data (i32.const 448) "asset_id == o.asset_id\00")
 (data (i32.const 480) "/usr/local/include/gxblib/asset.hpp\00")
 ...
 (data (i32.const 816) "deposit trx origin: \00")
 (data (i32.const 848) "deposit trx from: \00")
 (data (i32.const 880) "balance: \00")
 (data (i32.const 896) "owner exist, to modify\00")
 (data (i32.const 928) "operator+=\00")
 (data (i32.const 944) "cannot create objects in table of another contract\00")
 (data (i32.const 1008) "addbalance, \00")
 (data (i32.const 1024) ".\00")
 (data (i32.const 1040) " \00")
 (data (i32.const 9452) "\b83\00\00")
 (data (i32.const 9456) "Assertion failed: %s (%s: %s: %d)\n\00")
 (data (i32.const 9492) "(%\00\00")
 (data (i32.const 9512) "\05\00\00\00\00\00\00\00\00\00\00\00\05\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\06\00\00\00\07\00\00\00\c8%\00\00\00\04\00\00\00\00\00\00\00\00\00\00\01\00\00\00\00\00\00\00\00\00\00\00\00\00\00\n\ff\ff\ff\ff\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
    ...
    (block $label$2
     (block $label$3
      (block $label$4
       ...
       (drop
        (call $_ZN8graphene14execute_actionI4testS1_JyEEEbPT_MT0_FvDpT1_E
         (i32.add
          (get_local $7)
          (i32.const 72)
         )
      ...
      (drop
       (call $_ZN8graphene14execute_actionI4testNS_8contractEJyNS_5assetEEEEbPT_MT0_FvDpT1_E
        (i32.add
         (get_local $7)
         (i32.const 72)
        )
     ...
     (drop
      (call $_ZN8graphene14execute_actionI4testNS_8contractEJyyNS_5assetEEEEbPT_MT0_FvDpT1_E
       (i32.add
        (get_local $7)
        (i32.const 72)
       )
 ...
 (func $_ZN8graphene8contract7depositEyNS_5assetE (type $FUNCSIG$viji) (param $0 i32) (param $1 i64) (param $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i64)
  ...
  (call $_ZN8graphene8contract10addbalanceEyNS_5assetE
   (get_local $0)
   (get_local $1)
   (get_local $8)
  )
    ...
    (block $label$4
     ...
     (call $gxb_assert
      (i32.eq
       (i32.load offset=24
        (tee_local $5
         (call $_ZNK8graphene11multi_indexILy3607749779137757184ENS_8contract7accountEJEE31load_object_by_primary_iteratorEl
          (get_local $2)
          (get_local $5)
         )
        )
 ...
 (func $_ZN8graphene14execute_actionI4testNS_8contractEJyNS_5assetEEEEbPT_MT0_FvDpT1_E (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i64)
 ...
 (func $_ZN8graphene8contract8withdrawEyyNS_5assetE (type $FUNCSIG$vijji) (param $0 i32) (param $1 i64) (param $2 i64) (param $3 i32)
  (local $4 i64)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
  ...
  (call $_ZN8graphene8contract10subbalanceEyNS_5assetE
   (get_local $0)
   (get_local $1)
   (get_local $7)
  )
 ...
 (func $_ZN8graphene14execute_actionI4testNS_8contractEJyyNS_5assetEEEEbPT_MT0_FvDpT1_E (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i64)
 ...
 (func $_ZN4test2hiEy (type $FUNCSIG$vij) (param $0 i32) (param $1 i64)
  (call $prints
   (i32.const 32)
  )
  (call $printui
 ...
 (func $_ZN8graphene14execute_actionI4testS1_JyEEEbPT_MT0_FvDpT1_E (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i64)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $_ZN4test3byeEy (type $FUNCSIG$vij) (param $0 i32) (param $1 i64)
  (call $prints
   (i32.const 16)
  )
  (call $printui
 ...
 (func $_ZN8graphene8contract10subbalanceEyNS_5assetE (param $0 i32) (param $1 i64) (param $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  ...
  (block $label$2
   (block $label$3
    (block $label$4
     ...
     (call $_ZN8graphene11multi_indexILy3607749779137757184ENS_8contract7accountEJEE5eraseERKS2_
      (get_local $5)
      (get_local $6)
     )
     (br $label$2)
 ...
 (func $_ZNK8graphene11multi_indexILy3607749779137757184ENS_8contract7accountEJEE31load_object_by_primary_iteratorEl (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i64)
  ...
  (block $label$2
   ...
   (block $label$6
    ...
    (call $_ZNSt3__16vectorIN8graphene11multi_indexILy3607749779137757184ENS1_8contract7accountEJEE8item_ptrENS_9allocatorIS6_EEE24__emplace_back_slow_pathIJNS_10unique_ptrINS5_4itemENS_14default_deleteISC_EEEERyRlEEEvDpOT_
     (i32.add
      (get_local $0)
      (i32.const 24)
     )
 ...
 (func $_ZN8graphene11multi_indexILy3607749779137757184ENS_8contract7accountEJEE5eraseERKS2_ (param $0 i32) (param $1 i32)
  (local $2 i64)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $_ZN8graphene11multi_indexILy3607749779137757184ENS_8contract7accountEJEE6modifyIZNS1_10subbalanceEyNS_5assetEEUlRT_E_EEvRKS2_yOS6_ (param $0 i32) (param $1 i32) (param $2 i64) (param $3 i32)
  (local $4 i64)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
 ...
 (func $_ZNSt3__16vectorIN8graphene11multi_indexILy3607749779137757184ENS1_8contract7accountEJEE8item_ptrENS_9allocatorIS6_EEE24__emplace_back_slow_pathIJNS_10unique_ptrINS5_4itemENS_14default_deleteISC_EEEERyRlEEEvDpOT_ (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
 ...
 (func $_ZN8graphene8contract10addbalanceEyNS_5assetE (param $0 i32) (param $1 i64) (param $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  ...
  (block $label$2
   ...
   (call $_ZN8graphene11multi_indexILy3607749779137757184ENS_8contract7accountEJEE7emplaceIZNS1_10addbalanceEyNS_5assetEEUlRT_E_EENS3_14const_iteratorEyOS6_
    (i32.add
     (get_local $8)
     (i32.const 8)
    )
 ...
 (func $_ZN8graphene11multi_indexILy3607749779137757184ENS_8contract7accountEJEE7emplaceIZNS1_10addbalanceEyNS_5assetEEUlRT_E_EENS3_14const_iteratorEyOS6_ (param $0 i32) (param $1 i32) (param $2 i64) (param $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
  ...
  (call $_ZZN8graphene11multi_indexILy3607749779137757184ENS_8contract7accountEJEE7emplaceIZNS1_10addbalanceEyNS_5assetEEUlRT_E_EENS3_14const_iteratorEyOS6_ENKUlS7_E_clINS3_4itemEEEDaS7_
   (i32.add
    (get_local $7)
    (i32.const 16)
   )
 ...
 (func $_ZN8graphene11multi_indexILy3607749779137757184ENS_8contract7accountEJEE6modifyIZNS1_10addbalanceEyNS_5assetEEUlRT_E0_EEvRKS2_yOS6_ (param $0 i32) (param $1 i32) (param $2 i64) (param $3 i32)
  (local $4 i64)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
 ...
 (func $_ZZN8graphene11multi_indexILy3607749779137757184ENS_8contract7accountEJEE7emplaceIZNS1_10addbalanceEyNS_5assetEEUlRT_E_EENS3_14const_iteratorEyOS6_ENKUlS7_E_clINS3_4itemEEEDaS7_ (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i64)
  (local $4 i32)
  (local $5 i32)
