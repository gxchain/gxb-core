...
// for testnet after this time change to one vote only once logic
#define HARDFORK_1025_TIME (fc::time_point_sec( 1577329200 )) // for testnet, 2019-04-30T12:00:00(UTC)
#endif
