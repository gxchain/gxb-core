...
class database;
class transaction_js_context;
class apply_js_context {
   private:
     template <typename T>
   ...
   public:
      ...
      class gph_generic_index
      {
         public:
            ...
            gph_generic_index( apply_js_context& c ):context(c){}
         ...
         private:
            apply_js_context&              context;
            iterator_cache<ObjectType>  itr_cache;
      }; /// class gph_generic_index

   /// Constructor
   public:
     apply_js_context(database &d, transaction_js_context &trx_ctx, const action &a, optional<asset> amnt)
         : act(a)
         , trx_context(trx_ctx)
         , _db(&d)
         , amount(amnt)
   ...
   public:
      ...
      transaction_js_context&       trx_context; ///< transaction context in which the action is running
      database*                     _db;
