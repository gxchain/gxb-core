...
#define HARDFORK_1010_TIME (fc::time_point_sec( 1544470200 )) // for testnet, 2018-12-10T12:00:00
#endif

// contract call fee
#ifndef HARDFORK_1011_TIME
#define HARDFORK_1011_TIME (fc::time_point_sec( 1544470200 )) // for test, 2018-12-10T12:00:00
#endif

// update active trustnodes
#ifndef HARDFORK_1012_TIME
#define HARDFORK_1012_TIME (fc::time_point_sec( 1544470200 )) // for test, 2018-12-10T12:00:00
#endif
