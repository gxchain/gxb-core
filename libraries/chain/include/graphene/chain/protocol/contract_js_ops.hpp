...
struct contract_js_deploy_operation : public base_operation {
...
struct contract_js_call_operation : public base_operation {
    struct fee_parameters_type {
...
FC_REFLECT(graphene::chain::contract_js_deploy_operation::fee_parameters_type,
            (fee)(price_per_kbyte))
FC_REFLECT(graphene::chain::contract_js_deploy_operation,
            (fee)
            (name)
            (account)
            (vm_type)
...
FC_REFLECT(graphene::chain::contract_js_call_operation::fee_parameters_type,
            (fee)(price_per_kbyte_ram)(price_per_ms_cpu))
FC_REFLECT(graphene::chain::contract_js_call_operation,
            (fee)
            (account)
            (contract_id)
            (amount)
