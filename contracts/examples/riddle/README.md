...
unlocked >>> deploy_contract riddle nathan 0 0 ./contracts/examples/riddle GXC true
```
...
```shell
// 发起谜题
call_contract nathan riddle null issue "{\"question\":\"1 + 2 = ?\", \"hashed_answer\":\"810d7c3ca6aa6411102588f8636833035138a35f32f5e7b2df96d2ab2dc4d660\"}" GXC true
```
...
```
// 使用nathan帐户解谜
unlocked >>> call_contract nathan riddle null reveal "{\"issuer\":\"nathan\", \"answer\":\"I don't know.\"}" GXC true
```

4. 合约存储表

```
unlocked >>> get_table_rows riddle record 0 -1
[]
```
