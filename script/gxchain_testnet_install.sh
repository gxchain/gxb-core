...
if [ "$ARCH" == "Linux" ]; then
    ...
    curl -L 'https://github.com/gxchain/gxb-core/releases/download/testnet-1.0.181126/gxb_ubuntu_1.0.181126.testnet.tar.gz' -o gxb_ubuntu_1.0.181126.testnet.tar.gz
