...
namespace graphene { namespace chain {
     ...
     */
     ...
     typedef multi_index_container<
        pocs_object, indexed_by<
          ...
          ordered_non_unique<tag<by_product_id>, composite_key<pocs_object, member<pocs_object, object_id_type, &pocs_object::product_id>>>,
          ...
          member<pocs_object, object_id_type, &pocs_object::product_id>>>
        >
 ...
 FC_REFLECT_DERIVED (graphene::chain::pocs_object,
                     ...
                     (league_id)(account_id)(product_id)(total_sell)(total_buy))
