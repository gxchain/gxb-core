...
extern "C" {
    ...
    */
   void  gxb_assert( uint32_t test, const char* msg );
    ...
    */
   void  gxb_assert_message( uint32_t test, const char* msg, uint32_t msg_len );
    ...
    */
   void  gxb_assert_code( uint32_t test, uint64_t code );
    ...
    */
   [[noreturn]] void  gxb_exit( int32_t code );
