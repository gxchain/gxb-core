...
#define HARDFORK_1013_TIME (fc::time_point_sec( 1551398400 )) // for mainnet, 2019-03-01T00:00:00(UTC)
#endif

// add inline_transfer api for contract
#ifndef HARDFORK_1017_TIME
// should be updated before next release
#define HARDFORK_1017_TIME (fc::time_point_sec( 1551398400 )) // for mainnet, 2019-03-01T00:00:00(UTC)
#endif
...
// disable udpate_contract for normal account
#define HARDFORK_1016_TIME (fc::time_point_sec( 1551398400 )) // for mainnet, 2019-03-01T00:00:00(UTC)
#endif

#ifndef HARDFORK_1019_TIME
// for mainnet can transfer to contract account, can be removed after mainnet released
#define HARDFORK_1019_TIME (fc::time_point_sec( 1551398400 )) // for mainnet, 2019-03-01T00:00:00(UTC)
#endif
