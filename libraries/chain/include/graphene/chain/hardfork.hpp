...
#define HARDFORK_1022_TIME (fc::time_point_sec( 1585281600 )) // for mainnet, 2020-03-27T00:00:00(UTC)
#endif

#ifndef HARDFORK_1023_TIME
// for testnet after this time add api get_asset_precision
#define HARDFORK_1023_TIME (fc::time_point_sec( 1585281600 )) // for mainnet, 2020-03-27T00:00:00(UTC)
#endif

#ifndef HARDFORK_1024_TIME
// for testnet after this time modify update_contract logic
#define HARDFORK_1024_TIME (fc::time_point_sec( 1585281600 )) // for mainnet, 2020-03-27T00:00:00(UTC)
#endif

#ifndef HARDFORK_1025_TIME
// for testnet after this time modify vote logic
#define HARDFORK_1025_TIME (fc::time_point_sec( 1585281600 )) // for mainnet, 2020-03-27T00:00:00(UTC)
#endif

#ifndef HARDFORK_1026_TIME
// for testnet after this time fix staking_object expire check logic
#define HARDFORK_1026_TIME (fc::time_point_sec( 1585281600 )) // for mainnet, 2020-03-27T00:00:00(UTC)
#endif
...
#define HARDFORK_1027_TIME (fc::time_point_sec( 1585281600 )) // for mainnet, 2020-03-27T00:00:00(UTC)
#endif
