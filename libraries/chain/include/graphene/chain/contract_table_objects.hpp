...
CHAINBASE_SET_INDEX_TYPE(graphene::chain::table_id_object, graphene::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(graphene::chain::key_value_object, graphene::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(graphene::chain::index64_object, graphene::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(graphene::chain::index128_object, graphene::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(graphene::chain::index256_object, graphene::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(graphene::chain::index_double_object, graphene::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(graphene::chain::index_long_double_object, graphene::chain::index_long_double_index)

FC_REFLECT(graphene::chain::table_id_object, (id)(code)(scope)(table) )
FC_REFLECT(graphene::chain::key_value_object, (id)(t_id)(primary_key)(value)(payer) )
